...
namespace De.AHoerstemeier.Tambon
{
    class KontessabanDownloader
    {
        ...
        private String DoDownload()
        {
            ...
            var lReader = new StreamReader(lStream, Helper.ThaiEncoding);
            String lPlainWebsiteText = lReader.ReadToEnd();
            return lPlainWebsiteText;
        }
        private String DoLoadFromCache()
        {
            String lFilename = Path.Combine(AHGlobalSettings.HTMLCacheDir, CacheFilename);
        ...
        public List<KontessabanDataEntry> DoIt()
        {
            ...
            {
                lData = DoDownload();
                File.WriteAllText(lFilename, lData, Helper.ThaiEncoding);
            }
